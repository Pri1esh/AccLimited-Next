import { ErrorFallback, ImageBannerComponent, Layout, CustomHeading, AlternateParaSection } from '@components';
  ...
  return (
    ...
    >
      <>
        ...
        {main?.CommonPageData && <AlternateParaSection compData={main?.CardsData} />}
...
export default AmbujaAtAGlance;
