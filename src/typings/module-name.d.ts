...
declare module "react-shimmer-effects" {
    ...
    export const ShimmerPostItem: React.FC<{ card?: boolean; title?: boolean; text?: boolean; cta?: boolean }>;
    export const ShimmerPostDetails : React.FC<{ card?: boolean; variant:string; cta?: boolean }>;
    export const ShimmerThumbnail: React.FC<ShimmerProps>;
    export const ShimmerTable: React.FC<{ row: number; col: number }>;
    export const ShimmerPostList: React.FC<{postStyle:string; row: number; col: number; gap:number }>;
    export const ShimmerButton: React.FC<{ size?: "sm" | "md" | "lg" }>;
  }
