      ...
      <Container>
        <div className={styles.content}>
          ...
          <p className={styles.description}>
            Ambuja Cement's sustainable development initiatives cover a wide spectrum. From harnessing clean technology to using industrial wastes in cement production, energy conservation to deploying renewable energy and green energy, emissions reduction to creating institutionalised mechanisms to monitor environmental risks and strict adherence to the company's 'zero non-compliance' regime, Ambuja Cement's sustained efforts have helped ingrain the sustainability agenda in the company's DNA. All Ambuja Cements Limited plants are ISO 14001 certified.
          </p>
